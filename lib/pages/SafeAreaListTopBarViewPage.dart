...
import 'package:demo_adaptive_ui_1/components/ImageGalleryListView.dart';
import 'package:flutter/material.dart';

class SafeAreaListTopBarViewPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return TopNavigationBarChrome(
      child: ImageGalleryListView(imageUrls: imageUrls),
    );
  }
