...
import 'package:demo_adaptive_ui_1/chromes/TopBarNavigationChrome.dart';
import 'package:demo_adaptive_ui_1/components/ImageGalleryGridView.dart';
import 'package:flutter/material.dart';

class SafeAreaGridTopBarViewPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return TopNavigationBarChrome(
      child: ImageGalleryGridView(imageUrls: imageUrls),
    );
  }
